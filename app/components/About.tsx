      ...
      >
        ...
        >
          ...
          <motion.h4
            ...
            className="my-3 text-gray-700 font-Ovo dark:text-white"
          >
            Tool&apos;s I Used
          </motion.h4>
          ...
          >
            {toolsData.map((tool, index) => (
              <motion.li
                ...
                key={index}
                className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500 hover:shadow-black dark:border-white dark:hover:shadow-white"
              >

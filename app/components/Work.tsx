...
const Work = () => {
  return (
    <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
      <h4 className="text-center mb-1 text-lg font-Ovo">My Portfolio</h4>
      ...
      <div className="grid grid-cols-auto my-10 gap-5">
        {workData.map((project, index) => (
          ...
          >
            <div className="bg-white/80 w-10/12 rounded-md bottom-5 left-[-4rem]  absolute translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7">
              <div>
